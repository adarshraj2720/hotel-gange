    ...
    return (
        <div className={`wpo-destination-area ${props.dClass}`}>
            <div className="container">
                <SectionTitle MainTitle={'Packages for our clients according to their interests & requirements'} link={'/destination'}/>
                                ...
                                <div className="destination-item">
                                    ...
                                    <div className="destination-content">
                                        ...
                                        <div className="destination-bottom">
                                            <p> <span style={{color:"#2E85FF",fontSize:"22px",fontWeight:"800"}}>Rs{destination.price}</span>{destination?.per}</p>
